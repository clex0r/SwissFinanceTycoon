class eastScene extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.image('kantonEast', '././assets/images/ostschweizBig.png')
    ...
    create ()
    {
        ...
        //Kanton
        this.kanton = this.add.sprite(800, 450, 'kantonEast');

        //Button1
        this.buttonBank1 = this.add.sprite(710, 320, 'buttonBank1').setInteractive();
        //Button2
        this.buttonBank2 = this.add.sprite(870, 510, 'buttonBank2').setInteractive();
        //Button3
        this.buttonBank3 = this.add.sprite(760, 420, 'buttonBank3').setInteractive();
        //Button Back
        ...
        originScene='eastScene';
        bankTypeChosen="thurgau";
        ...
        shownText="Hier kannst du neue Banken in der Ostschweiz kaufen";   
        originScene='eastScene'; 
