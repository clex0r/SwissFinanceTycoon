class southScene extends Phaser.Scene {

    constructor ()
    {
        super({ key: 'southScene' });
    }
    ...
    preload ()
    {
        ...
        this.load.image('kantonSouth', '././assets/images/suedschweizBig.png')
    ...
    create ()
    {
      ...
      //Kanton
      this.kanton = this.add.sprite(800, 450, 'kantonSouth');

      //Button1
      this.buttonBank1 = this.add.sprite(660, 480, 'buttonBank1').setInteractive();
      //Button2
      this.buttonBank2 = this.add.sprite(790, 460, 'buttonBank2').setInteractive();
      //Button3
      this.buttonBank3 = this.add.sprite(970, 420, 'buttonBank3').setInteractive();
      //Button Back
      ...
      this.buyText = this.add.text(50, 838, 'Investieren', { font: "30px Arial", color: 0xffffff });
        ...
        originScene='southScene';
        bankTypeChosen="sudwallis";
        ...
        shownText="Hier kannst du Banken in der Südschweiz kaufen";   
        originScene='southScene'; 
