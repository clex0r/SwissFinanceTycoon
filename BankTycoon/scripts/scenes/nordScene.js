class nordScene extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.image('kantonNorth', '././assets/images/nordschweizBig.png')
    ...
    create ()
    {
      ...
      this.logo = this.add.sprite(310, 100, 'logo');
        //Anzeigetafel
        this.anzeige = this.add.sprite(1325, 155, 'anzeige');
        //Text
      ...
      //Kanton
      this.kanton = this.add.sprite(800, 450, 'kantonNorth');

      //Button1
      this.buttonBank1 = this.add.sprite(730, 460, 'buttonBank1').setInteractive();
      //Button2
      this.buttonBank2 = this.add.sprite(850, 330, 'buttonBank2').setInteractive();
      //Button3
      this.buttonBank3 = this.add.sprite(840, 540, 'buttonBank3').setInteractive();
      //Button Back
      ...
      this.buttonBank1.on('pointerdown', function (event) {
        originScene='nordScene';
        bankTypeChosen="luzern";
      ...
      this.buttonHelp.on('pointerdown', function (event) { 
        shownText="Hier kannst du Banken in der Nordschweiz kaufen";   
        originScene='nordScene'; 
